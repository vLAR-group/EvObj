...
class Trainer(object):
    def __init__(self, model, objnet, PPO_actor, PPO_critic, logger, train_dataset, val_dataset, save_path, cfg=None, use_norm=True, use_label=False, val_RL_dataset=None):
        ...
        for iter in range(self.batch_iter):
            ...
            if self.training_iter % self.logging_interval == 0:
                ...
                self.logger.info(
                    ...
                    'dice: {:.3f}, class: {:.3f}, lr: {:.3e}, Traj: {:.2f}, infer time: {:.1f}s, data time: {:.1f}s, optimize time: {:.1f}s, Elapsed time: {:.1f}s ({} iters)'.format(
                        time.strftime(
    ...
    def train_model(self, epochs):
        ...
        for epoch in range(start, epochs):
            for batch_idx, batch in enumerate(train_data_loader):
                # print(f"Training batch {batch_idx}/{len(train_data_loader)}") # for debug
                # if batch_idx > 20: 
                #     break
