...
import analysing_acc_and_suff_grabs
import torch
import numpy as np
...
def config_parser():
    ...
    parser.add_argument("--cd_thr", type=float, default=0.14, help='CD threshold for reward computation, GrabS default setting')
...
def main(cfg, logger):
    ...
    #########################
    trainer = analysing_acc_and_suff_grabs.Trainer(
